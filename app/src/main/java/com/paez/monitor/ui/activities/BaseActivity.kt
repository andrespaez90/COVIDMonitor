...
import com.paez.monitor.ui.factories.SnackBarFactory
import com.paez.monitor.ui.fragments.BaseFragment
import com.paez.monitor.ui.views.Loading
import com.paez.monitor.viewModels.AndroidViewModel
import com.paez.monitor.viewModels.models.*
import java.util.*
...
open class BaseActivity : AppCompatActivity() {
    ...
    protected fun subscribeViewModel(viewModel: AndroidViewModel, root: View) {
        ...
        viewModel.snackBarMessage().observe(this, Observer { showMessage(it, root) })
    }
    ...
    protected fun showMessage(event: SnackBarEvent, root: View) {
        showMessage(event.typeSnackBar, root, event.message, Snackbar.LENGTH_SHORT)
    }
